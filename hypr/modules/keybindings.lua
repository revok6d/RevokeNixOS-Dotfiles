...
hl.bind("Print", hl.dsp.exec_cmd(
  'mkdir -p "$HOME/Pictures/Screenshots" && grim - | tee "$HOME/Pictures/Screenshots/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png" | wl-copy -t image/png'
))
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd(
  'mkdir -p "$HOME/Pictures/Screenshots" && region=$(slurp) && grim -g "$region" - | tee "$HOME/Pictures/Screenshots/Screenshot_$(date +%Y-%m-%d_%H-%M-%S).png" | wl-copy -t image/png'
))